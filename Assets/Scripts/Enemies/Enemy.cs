...
{
    [Header("Settings")]
    [Tooltip("Đánh dấu đây là Boss hay quái thường")]
    ...
    public void DoBeforeDestroy()
    {
        ...
        if (isBoss)
        {
            // Chỉ boss mới trigger thắng
            GameManager.instance.LevelCleared();
        }
        else
        {
            // Nếu màn bình thường → đếm quái
            // Nếu màn boss → quái phụ không đếm
    ...
    {
        if (movementMode == MovementModes.FollowTarget)
        {
