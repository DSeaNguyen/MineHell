...
public class GameManager : MonoBehaviour
{
    ...
    [Tooltip("Nếu là màn boss thì thắng khi boss chết, bỏ qua số lượng enemy khác.")]
    ...
    {
        enemiesDefeated++;
        if (!isBossLevel && enemiesDefeated >= enemiesToDefeat && gameIsWinnable)
        {
            LevelCleared();
        }
    }
    ...
    public void LevelCleared()
    {
        ...
        if (UIManager.instance != null)
        {
            ...
            if (victoryEffect != null)
                Instantiate(victoryEffect, transform.position, transform.rotation);
        }
    }
